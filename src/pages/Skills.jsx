                        ...
                        {skillCategories.map((category, idx) => (
                            ...
                            >
                                <div className="flex items-center space-x-4 mb-6">
                                    <div className="p-3 bg-soft-pink/10 rounded-sm group-hover:bg-soft-pink/20 transition-colors">
                                        {category.icon}
                                    </div>
